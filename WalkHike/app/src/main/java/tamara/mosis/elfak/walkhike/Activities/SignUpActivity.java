  ...
  public class SignUpActivity extends AppCompatActivity {
      ...
      TextView orLogIn;
        ...
        protected void onCreate(Bundle savedInstanceState)
        {
            ...
            txtreenteredPassword=(EditText) findViewById(R.id.signup_pass_reenter);
            ...
            // Toast.makeText(getApplicationContext(), "done", Toast.LENGTH_SHORT).show();
                ...
                boolean b=txtreenteredPassword.getText().toString().equals(txtPassword.getText().toString());
                if(b==false)
                {
                    proceedWithRegistration=false;
                    Toast.makeText(getApplicationContext(), "The password is not re-entered correctly", Toast.LENGTH_LONG).show();
                }
                if(userData.getInstance().getUserByUsername(txtUsername.getText().toString())!=null)
                {
                    proceedWithRegistration = false;
                    Toast.makeText(getApplicationContext(), "The entered username is already taken", Toast.LENGTH_LONG).show();
                }
